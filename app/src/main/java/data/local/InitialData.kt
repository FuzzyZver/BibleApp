...
fun getInitialBooks(): List<BookEntity> {
    ...
    return listOf(
        ...
        BookEntity(
            ...
            pageCount = 357,
            coverResId = R.drawable.oru_1984,
        ...
        BookEntity(
            ...
            pageCount = 694,
            coverResId = R.drawable.prest_nakaz,
            quote = "❝ Смогу ли я переступить или не смогу! Осмелюсь ли нагнуться и взять или нет? Тварь ли я дрожащая или право имею! ❞"
        ),
        BookEntity(
            title = "Старик и море",
            ...
            pageCount = 331,
            coverResId = R.drawable.starik_i_more,
            quote = "❝ Счастье приходит к человеку во всяком виде, разве его узнаешь? Я бы, положим, взял немного счастья в каком угодно виде и заплатил за него все, что спросят. ❞"
        ),
        //История
        BookEntity(
            ...
            pageCount = 2271,
            coverResId = R.drawable.arhipelag_gulag,
            quote = "❝ Смирная овца волку по зубам. ❞"
        ),
        BookEntity(
            ...
            pageCount = 417,
            coverResId = R.drawable.srednevekovaya_anglia,
            quote = "«Как только вы начнёте думать о прошлом как о чём-то, что происходит (а не когда-то произошло), то сможете новыми глазами взглянуть на историю»"
        ),
        BookEntity(
            ...
            pageCount = 326,
            coverResId = R.drawable.zapiski_o_galskoi_voine,
            quote = "«Наконец, разве не верх легкомыслия и позора – принимать ответственные решения по совету врага?»"
        ),
        //Наука
        BookEntity(
            ...
            pageCount = 320,
            coverResId = R.drawable.kratkaya_istoria_vremeni,
            quote = "«В общей теории относительности нет единого абсолютного времени; каждый индивидуум имеет свой собственный масштаб времени, зависящий от того, где этот индивидуум находится и как он движется.»"
        ),
        BookEntity(
            ...
            pageCount = 640,
            coverResId = R.drawable.kratkaia_istoria_pohti_vsego_na_svete,
            quote = "«В том и состоит курьезность нашего существования, что мы обитаем на планете, которая очень хорошо поддерживает жизнь, но ещё лучше её истребляет»"
        ),
        BookEntity(
            ...
            pageCount = 544,
            coverResId = R.drawable.bog_kak_illuzia,
            quote = "«Когда навязчивые иллюзии появляются у одного человека, это сумасшествие. Когда они появляются сразу у многих, это религия»"
        )
    )
}